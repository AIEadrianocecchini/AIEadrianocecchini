...
namespace _1942Remake
{
    public class Explosion
    {
        ...
        public Explosion(Texture2D newTexture, Vector2 newPosition)
        {
            ...
            interval = 10f;
            currentFrame = 1;
            //the size of each indiviual image on sprite sheet
            spriteWidth = 128;
            spriteHeight = 128;
            isVisible = true;
        }
        ...
        public void Update(GameTime gameTime)
        {
            ...
            // If we are on the last frame make the explosion invisible and reset current frame to beginning of the spritesheet
            if (currentFrame == 17)
            {
                isVisible = false;
                currentFrame = 0;
